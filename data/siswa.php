...
// Ambil data kelas untuk dropdown (alumni tetap tampil untuk keperluan naik kelas)
...
// Logic Filter & Query Data Siswa (default hanya siswa aktif, alumni tampil jika dipilih di filter)
...
if ($filter_kelas !== '') {
    ...
    // Default: exclude alumni agar total siswa hanya menghitung siswa aktif
