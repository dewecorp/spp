        ...
        foreach ($dataSiswa as $siswa) {
            ...
            if (mysqli_num_rows($cek) > 0) {
                $sql = "UPDATE siswa SET 
                        ...
                        tgl_lahir = '$tanggal', nama_wali = '$wali'
                        WHERE nisn = '$nisn'";
                ...
                $sql = "INSERT INTO siswa (nisn, nama, id_kelas, alamat, no_telp, jenis_kelamin, tempat_lahir, tgl_lahir, nama_wali, tanggal_masuk) 
                        VALUES ('$nisn', '$nama', '$id_kelas', '-', '', '$gender', '$tempat', '$tanggal', '$wali', CURDATE())";
                if (mysqli_query($koneksi, $sql)) {
                    $success_count++;
                } else {
                    $error_count++;
