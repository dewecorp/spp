                    ...
                    <?php if ($d_jenis['tipe_bayar'] == 'Bulanan') { ?>
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                $chunks = array_chunk($bulan, 6); // Split into 2 columns of months if needed? No, just list them compact.
                                // Actually listing 12 rows takes space. Let's try to make it compact.
                                // User said "Detail", so I keep rows. But maybe small padding.
